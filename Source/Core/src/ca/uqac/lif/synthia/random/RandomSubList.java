...
public class RandomSubList<T> implements RelativePicker
{
	 ...
	 */
	protected RelativePicker<T> m_listReducer;
	 ...
	 */
	public RandomSubList(List<T> elements, RelativePicker<T> list_reducer)
	{
	...
	public List<T> pick()
	{
		...
		for (T m_element : m_elements)
		{
			if (m_pick.pick())
			{
				...
				{
					output_list.add(m_listReducer.getPicker(m_element).pick());
				}
			}
		}
	...
	@Override public RelativePicker getPicker(Object element)
	{
		...
		else
		{
			...
			return new RandomSubList(m_pick, m_asIs.duplicate(true), objects,
