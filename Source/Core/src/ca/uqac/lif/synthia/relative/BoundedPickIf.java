...
public class BoundedPickIf<T> extends PickIf<T> implements Bounded<T>
{
	 ...
	 */
	public BoundedPickIf(Picker<? extends T> picker)
	{
		super(picker);
	}
	 ...
	 */
	public BoundedPickIf(Picker<? extends T> picker, int max_iteration)
	{
		super(picker);
	}
	...
	{
		BoundedPickIf<T> pif = new BoundedPickIf<T>(m_picker.duplicate(with_state), m_maxIteration);
